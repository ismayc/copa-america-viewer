...
// Once a team has clinched a quarter-final place, show who they're set to play
...
// `knockout` is set only when a selected team has clinched a quarter-final place.
