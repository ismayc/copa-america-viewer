...
// Tooltip describing which quarter-final slot this team feeds into, given its
...
function slotTooltip(group, slot, clinch) {
  ...
  const qf = (num) => `Quarter-final · Match ${num}`
    ...
    <article className={`card status-${status}`}>
      ...
      <div className="card-body">
        ...
        {/* Cross-source confirmation of the final score (OpenFootball / ESPN).
            Hidden in spoiler mode along with the score itself, and never shown
            for a voided match (its score isn't a real result). */}
