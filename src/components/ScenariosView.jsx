...
// "As it stands → quarter-finals" line for a projected qualifier. `confirmed` is
...
export default function ScenariosView({ matches }) {
  ...
  // quarter-final locks only when BOTH of its groups are settled — so check both
    ...
    <div className="scenarios">
      <div className="sc-intro">
        <p>
          ...
          quarter-finals would shake out. Deterministic — no predictions, just the consequences of
          ...
          return (
            <div className="sc-card" key={g}>
              ...
              <div className="sc-entry">
                <div className="sc-entry-title">Projected quarter-finals</div>
      ...
      <p className="sc-foot">
        ...
        quarter-final pairs two different groups, so an exact opponent only firms up as you set
