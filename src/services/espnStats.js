...
const CORE = 'https://sports.core.api.espn.com/v2/sports/soccer/leagues/conmebol.america/seasons/2024'
export const LEADERS_SOURCE = {
  name: 'ESPN',
  url: `${CORE}/types/1/leaders?lang=en&region=us`,
}

const CACHE_KEY = 'copa:bootExtras'
const NAMES_KEY = 'copa:athleteNames'
...
const MATCH_STAT_PREFIX = 'copa:matchStat:' // `${eventId}:${athleteId}` → {a, m} (final games only)
