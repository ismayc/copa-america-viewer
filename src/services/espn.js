...
//
// Scores are cross-checked against OpenFootball — see
...
export const LIVE_SOURCE = {
  name: 'ESPN',
  url: 'https://site.web.api.espn.com/apis/site/v2/sports/soccer/conmebol.america/scoreboard',
...
//
// Empty for Copa América 2024: ESPN's scoreboard names all sixteen sides exactly
// as we do — verified against every one of the 32 matches and pinned by
...
// "tomorrow" in UTC, so filing by the UTC day asked for a slate that didn't contain
// the match — and its cards/subs never reached the detail view or the conduct
// tiebreak. The live window survives this only because it spans ±1 day.
...
// ('post'). Mirrors the getter in results.js.
